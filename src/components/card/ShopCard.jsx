    ...
    <div className=" group w-full max-w-sm bg-white rounded-2xl font-Ubuntu shadow-lg">
      <div className=" relative flex flex-col items-center pb-1">
        <img
          ...
          src="https://i.etsystatic.com/37458453/c/1467/1166/420/332/il/d2b82d/4935672921/il_680x540.4935672921_kelb.jpg"
          alt="Bonnie image"
        />
        ...
        <div className=" px-4">
          ...
          <div className=" text-sm mt-1  space-x-8 justify-between flex items-center">
            <div>
              <div className=" text-center text-xl font-bold">24</div>
              <div>Products</div>
            </div>
            <div>
          ...
          <div className="flex my-1 space-x-3">
            <button className=" group/button hover:scale-y-105 hover:shadow-xl my-3 w-full border-2 border-black mb-2 font-semibold text-base rounded-2xl py-3 px-6 items-center transition-all delay-0 duration-300 ease-in-out">
