    ...
    <div className=" py-4 ">
      ...
      {active === 1 ? (
        <p className=" py-2 leading-8 pb-10 whitespace-pre-line">
          ...
          eveniet voluptatum sapiente culpa perferendis deleniti impedit
          distinctio id itaque nisi, beatae commodi eius optio iure odit
          molestias obcaecati architecto!
        </p>
      ) : null}
      {active === 2 ? (
